...
class Router {
    ...
    async loadAboutPage() {
        ...
        try {
            mainContent.innerHTML = Pages.getAboutPage();
        } catch (error) {
    ...
    async loadPostPage(postId) {
        ...
        try {
            ...
            const post = Pages.getPostContent(postId);
            const posts = await Posts.loadPosts();
                        ...
                        <div class="post-header">
                            ...
                            <div class="author-card">
                                ...
                                <div class="author-info">
                                    ...
                                    <div class="post-meta">${post.date} · ${Math.floor(post.content.length / 500)} 分钟阅读</div>
                                </div>
                                <button class="follow-btn">关注</button>
                            </div>
                            <div class="post-tags">${coloredTags}</div>
                            <div class="post-featured-image" style="background: linear-gradient(45deg, #${this.getRandomColor()}, #${this.getRandomColor()});">
                        ...
                        <div class="related-posts-list">
                            ${relatedPosts.map(relatedPost => `
                                <a href="#posts/${relatedPost.id}" class="related-post-card">
                                    <div class="related-post-image" style="background: linear-gradient(45deg, #${this.getRandomColor()}, #${this.getRandomColor()});">
                                        <div class="image-placeholder">
                                            <i class="fas fa-image"></i>
